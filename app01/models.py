...
class It(models.Model):
    # 接口项目表
    it_name = models.CharField(max_length=64, default='', verbose_name='项目名称')
    it_desc = models.CharField(max_length=256, default='', verbose_name='项目描述')
...
class Api(models.Model):
    # 项目测试用例
    api_sub_it= models.ForeignKey(to='It',on_delete=models.CASCADE , verbose_name='所属接口项目')
    ...
    api_method = models.CharField(max_length=32, default='', verbose_name='请求的类型')
    api_params = models.CharField(max_length=255, default={}, verbose_name='请求的参数')
    api_data = models.CharField(max_length=255, default={}, verbose_name='请求的data')
    api_exprct = models.CharField(max_length=4196, default={}, verbose_name='预期结果')
...
class Logs(models.Model):
    '''用例执行记录
        ...
        2.执行时间
        3.执行的测试报告
        4.通过多少，失败多少，共执行多少，通过率
    '''
    log_report=models.TextField(verbose_name='报告',default='')
    log_sub_it = models.ForeignKey(to='It',on_delete=models.CASCADE, verbose_name='所属接口的项目')
