# Generated by Django 3.2 on 2022-07-11 06:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_url', models.CharField(default='', max_length=32, verbose_name='请求的url')),
                ('api_method', models.CharField(default='', max_length=32, verbose_name='请求的类型')),
                ('api_params', models.CharField(default={}, max_length=32, verbose_name='请求的参数')),
                ('api_data', models.CharField(default={}, max_length=32, verbose_name='请求的data')),
                ('api_exprct', models.CharField(default={}, max_length=32, verbose_name='预期结果')),
